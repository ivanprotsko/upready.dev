  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <ButtonGroup className="shadow-lg">
        <Button 
          className="bg-background hover:bg-muted font-bold h-9 w-10 p-0 text-base border border-border text-foreground"
        >
          {currency.symbol}
        </Button>
        ...
        >
          <SelectTrigger className="rounded-l-none h-9 min-w-20 font-bold">
            <SelectValue />
          </SelectTrigger>
