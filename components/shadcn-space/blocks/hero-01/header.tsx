...
const Header = ({ navigationData, className, buttonText }: HeaderProps) => {
    ...
    >
      ...
      >
        ...
        <div className="flex gap-4">
          <CollaborateButton className="hidden lg:flex" buttonText={buttonText} />
                ...
                >
                  ...
                  <div className="flex flex-col gap-12 px-6 pb-6 overflow-y-auto">
                    <div className="flex flex-col gap-8">
                      ...
                      <div className="w-fit">
                        <CollaborateButton buttonText={buttonText} />
                      </div>
                    </div>
