...
import { NavMain } from "@/components/shadcn-space/blocks/dashboard-shell-02/nav-main";
import { AlignStartVertical, BarChart3, ChartPie, CircleUserRound, ClipboardList, CreditCard, Languages, LayoutPanelTop, LucideIcon, Notebook, NotepadText, Table, Ticket, } from "lucide-react";
import { SiteHeader } from "@/components/shadcn-space/blocks/dashboard-shell-02/site-header";
...
export const navData: NavItem[] = [
    ...
    { title: "CRM Dashboard", icon: ClipboardList, href: "#", isActive: true },
