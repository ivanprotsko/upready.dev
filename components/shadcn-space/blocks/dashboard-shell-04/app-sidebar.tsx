...
import { NavMain } from "@/components/shadcn-space/blocks/dashboard-shell-04/nav-main";
...
import { SiteHeader } from "@/components/shadcn-space/blocks/dashboard-shell-04/site-header";
...
export const navData: NavItem[] = [
    ...
    { title: "eCommerce", icon: ClipboardList, href: "#", isActive: true },
    { title: "CRM Dashboard", icon: BarChart3, href: "#", },
