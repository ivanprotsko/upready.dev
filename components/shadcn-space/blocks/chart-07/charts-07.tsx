...
export default function Charts07({ className }: { className?: string }) {
  const dropdownItems = ["2025", "2024"];
  ...
  const currentData = statsData[selectedYear] || statsData["2025"];
  ...
  return (
    <Card className={className}>
      <CardHeader className="flex items-center lg:flex-nowrap flex-wrap lg:gap-0 gap-2 justify-between pb-5 border-b border-border">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <Badge className="bg-transparent text-chart-2 dark:text-chart-2">
                {currentData.onlinePercent}
              </Badge>
            </div>
          </div>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <Badge
                className={cn(
                  "hover:bg-opacity-20",
                  currentData.isOfflinePositive
                    ? "bg-transparent text-chart-2 dark:text-chart-2"
                    : "bg-transparent   text-chart-1 dark:text-chart-1",
                )}
              >
                {currentData.offlinePercent}
              </Badge>
            </div>
          </div>
        </div>
        <div className="h-53.75">
          <ChartContainer
