...
import LanguageDropdown from "@/components/shadcn-space/blocks/topbar-02/dropdown-language"
import ProfileDropdown from "@/components/shadcn-space/blocks/topbar-02/dropdown-profile"
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <header className="sticky top-0 z-50 border-b bg-background">
                ...
                <div className="flex items-center justify-between max-w-7xl mx-auto p-4">
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <LanguageDropdown
                            trigger={
                                <Button
                                    id="language-dropdown-trigger-02"
                                    variant='ghost'
                                    size='icon'
                        ...
                        <ProfileDropdown
                            trigger={
                                <Button
                                    id="profile-dropdown-trigger-02"
                                    variant='ghost'
                                    size='icon'
                ...
                {/* NAVIGATION BAR */}
                <div className="hidden lg:flex items-center justify-start px-4 py-2 max-w-7xl mx-auto">
                    <NavigationMenu>
