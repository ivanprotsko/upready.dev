  ...
  return (
    <>
      {summeryData.map((item, index) => (
        <Card key={index} className={cn("w-full max-w-44 ring-0", item.bgColor)}>
          <CardContent className="h-full flex flex-col gap-12">
            <div className={cn("rounded-lg p-3 w-fit", item.bgColor)}>
