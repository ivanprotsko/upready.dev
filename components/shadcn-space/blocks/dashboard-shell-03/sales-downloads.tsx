...
import "@/components/shadcn-space/blocks/dashboard-shell-03/sales-downloadstyle.css";
    ...
    const SalesFromLocationData = [
        {
            ...
            percentage: 28,
            color:
                "**:data-[slot=progress-indicator]:bg-sky-400 **:data-[slot=progress-track]:bg-sky-400/10",
        },
        {
            name: "NY",
            percentage: 21,
            color:
                "**:data-[slot=progress-indicator]:bg-blue-500 **:data-[slot=progress-track]:bg-blue-500/10",
        },
        {
            name: "KA",
            percentage: 18,
            color:
                "**:data-[slot=progress-indicator]:bg-amber-300 **:data-[slot=progress-track]:bg-amber-300/10",
        },
        {
            name: "AZ",
            percentage: 12,
            color:
                "**:data-[slot=progress-indicator]:bg-red-500 **:data-[slot=progress-track]:bg-red-500/10",
        },
    ];
